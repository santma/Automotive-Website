        ...
        <div class="container-fluid accent-color" style = "line-height: 2;">
          ...
          <div class="d-none" id="mobile-menu">
            ...
            <div class="d-none" id="contact-menu-mobile">
              ...
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a href="#" title="Contact Download" class="contact menu">
                  <i class="fas fa-address-book fa-sm"></i> Save Contact</a>
                </div>
              </div>
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
            ...
            <div class="d-none" id="services-menu-mobile">
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a href="<?php echo get_page_link( get_page_by_title( 'Brakes' )->ID );?>" class="menu">Brake Repair</a>
                </div>
              </div>
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a  href="<?php echo get_page_link( get_page_by_title( 'Oil Change' )->ID );?>" class="menu">Oil Changes</a>
                </div>
              </div>
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a  href="<?php echo get_page_link( get_page_by_title( 'Transmission' )->ID );?>" class="menu">Transmissions</a>
                </div>
              </div>
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a  href="<?php echo get_page_link( get_page_by_title( 'Suspension' )->ID );?>" class="menu">Suspension</a>
                </div>
              </div>
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a href="<?php echo get_page_link( get_page_by_title( 'Tires' )->ID );?>" class="menu">Tires</a>
                </div>
              </div>
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
            ...
            <div class="d-none" id="programs-menu-mobile">
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a href = "<?php echo get_page_link( get_page_by_title( 'Financing' )->ID );?>" class="menu">Financing</a>
                </div>
              </div>
              <div class="row sub-menu mobile-sub">
                <div class="col offset-5">
                  <a href = "<?php echo get_page_link( get_page_by_title( 'Fleet Services' )->ID );?>" class="menu">Fleets</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="container-fluid accent-color" style = "line-height: 2;">
                  ...
                  <div class="d-none" id="contact-menu-tablet">
                    ...
                    <div class="row sub-menu">
                      <div class="col offset-md-4">
                        <a href="#" title="Contact Download" class="contact menu">
                        <i class="fas fa-address-book fa-md"></i> Save Contact</a>
                      </div>
                    </div>
                    <div class="row sub-menu">
                      <div class="col offset-md-4">
        ...
        <div class="container-fluid navigation-bar d-none d-lg-block" style="padding: 0px;">
          ...
          <div class="container-fluid accent-color" style = "line-height: 2; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <div class="d-none accent-color" id="contact-menu-desktop">
              <div class="container" style="position: absolute;max-width: max-content;padding-left: 32%;">
            ...
            <div class="d-none accent-color" id="tires-menu-desktop">
              <div class="container" style="position: absolute;max-width: max-content;padding-left: 54%;">
              <div class="row sub-menu accent-color">
                <div class="col">
          ...
          <div class="d-none accent-color" id="services-menu-desktop">
            <div class="container" style="position: absolute;max-width: max-content;padding-left: 44%;">
            <div class="row sub-menu accent-color">
              <div class="col">
                <a  href="<?php echo get_page_link( get_page_by_title( 'Brakes' )->ID );?>" class="menu">Brake Repair</a>
              </div>
            ...
            <div class="row sub-menu accent-color">
              <div class="col">
                <a  href="<?php echo get_page_link( get_page_by_title( 'Electrical Systems' )->ID );?>" class="menu">Electrical System</a>
              </div>
            </div>
            <div class="row sub-menu accent-color">
              <div class="col">
                <a  href="<?php echo get_page_link( get_page_by_title( 'Wheel Alignment' )->ID );?>" class="menu">Wheel Alignment</a>
              </div>
            </div>
            <div class="row sub-menu accent-color">
              <div class="col">
                <a  href="<?php echo get_page_link( get_page_by_title( 'Steering' )->ID );?>" class="menu">Steering Repair</a>
              </div>
            </div>
            <div class="row sub-menu accent-color">
              <div class="col">
