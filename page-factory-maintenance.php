...
<?php $factory_maintenance = get_field("factory_maintenance");?>
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-4">
              <div class="container" style="margin: 1em;">
                <p><?php echo $factory_maintenance["about_factory_maintenance"];?></p>
              </div>
            </div>
            <div class="col-sm-12 col-lg-8">
              <div class="embed-container" style="margin: 35px;">
                <?php echo $financing["factory_maintenance_video"];?>
              </div>
            </div>
          </div>
        </div>
